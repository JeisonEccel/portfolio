  ...
  return (
    <Section id="about">
      ...
      <div className="flex flex-col gap-4">
        <Paragraph>
          I was born and raised in Joinville, SC—a dynamic industrial city known
          as the &quot;Manchester Catarinense&quot; for its thriving mechanical
          and manufacturing hub, home to Brazil&apos;s largest mold-making and
          metalworking industries and host of the world-renowned Joinville Dance
          Festival. My earliest memories are filled with sketches—from animals
        ...
        <Paragraph>
          ...
          logistics expert—experiences that shaped my ambition to pursue further
          study in Production Engineering at UDESC, one of Brazil&apos;s
        ...
        <Paragraph>
          ...
          customers—but realized I needed to improve my English to bridge global
          opportunities. That led me to Centennial College in Toronto to study
          Project Management and start my Canadian journey.
        </Paragraph>
        <Paragraph>
